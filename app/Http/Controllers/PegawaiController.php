...
use App\Models\DataPegawai as DataGuru;
use App\User;
use Auth;
...
class PegawaiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('data-pegawai')->with('message', format_message('Berhasil menyimpan data !', 'success'));
    }

    public function edit($id)
    {
        $data = DataGuru::findOrFail($id);
        return view('data-pegawai.edit', [
            'data' => $data,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            return redirect()->route('data-pegawai.edit', ['id' => $guru->id])
                ->withErrors($validator)
                ->withInput()
        ...
        return redirect()->route('data-pegawai')->with('message', format_message('Berhasil update data !', 'info'));
    }
    ...
    public function destroy(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('data-pegawai')->with('message', format_message('Berhasil menghapus!', 'info'));

        } catch (\Illuminate\Database\QueryException $e) {
            // var_dump($e->errorInfo );
            return redirect()->route('data-pegawai')->with('message', format_message('Cannot delete! The data has relation in User', 'danger'));
        }
