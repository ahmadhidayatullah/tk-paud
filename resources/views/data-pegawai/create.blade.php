...
@section('content')
{{-- <section class="row"> --}}
<form action="{{route('data-pegawai.create.submit')}}" method="post">
    <div class="row">
                  ...
                  <h3 class="card-title">Data Pegawai</h3>
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" class="form-control {{ $errors->has('ket') ? ' is-invalid' : '' }}" placeholder="Keterangan" name="ket" value="{{old('ket')}}">
                        @if ($errors->has('ket')) 
